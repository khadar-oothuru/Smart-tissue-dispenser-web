...
const DeviceStatusDistribution = ({ 
  ...
  const title = `${selectedAlertType === 'tissue' ? 'Tissue' : 'Battery'} Status Distribution`;
    ...
    <div className="card p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
      <div className="flex justify-between items-center mb-6">
        ...
        {onRefresh && (
          ...
          >
            <RefreshCw className={`h-5 w-5 text-gray-500 dark:text-gray-400 ${isLoading ? 'animate-spin' : ''}`} />
          </button>
        )}
      </div>
